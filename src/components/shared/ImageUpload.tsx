    ...
    <div className={className}>
      ...
      {!preview ? (
        <button
          ...
          disabled={uploading}
          className="w-full border-2 border-dashed border-neon-orange shadow-neon-orange hover:border-neon-orange shadow-neon-orange-strong rounded-xl p-8 transition-colors flex flex-col items-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <div className="w-16 h-16 bg-nnh-orange/10 rounded-full flex items-center justify-center">
        ...
        <div className="relative rounded-xl overflow-hidden border border-neon-orange shadow-neon-orange">
          <img
            src={preview}
            alt="Upload preview"
          ...
          {uploading ? (
            <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center gap-3">
              ...
              <div className="w-48">
                <div className="h-2 bg-nnh-orange/20 rounded-full overflow-hidden">
                  <div
