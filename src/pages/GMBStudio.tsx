...
function GMBStudio() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative">
          <select
            ...
            disabled={loading}
            className="appearance-none bg-black border border-neon-orange shadow-neon-orange rounded-lg px-4 py-3 pr-10 text-white focus:outline-none focus:border-white/40 transition-colors min-w-[250px]"
          >
      ...
      {/* Tabs */}
      <div className="border-b border-neon-orange shadow-neon-orange">
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-3 rounded-t-lg font-medium transition-all whitespace-nowrap flex-shrink-0 ${
                  isActive
                    ? 'bg-gradient-to-r from-orange-500 via-orange-600 to-orange-500 text-black font-semibold border-b-2 border-white'
                    : 'text-white hover:text-white hover:bg-nnh-orange/5'
                }`}
              >
