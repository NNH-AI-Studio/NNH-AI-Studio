  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-white mt-2">Configure AI providers for automated responses and content generation</p>
      </div>
      ...
      <div className="space-y-4">
        {providers.map((provider, index) => (
          <motion.div
            ...
            className="bg-black rounded-xl border border-neon-orange shadow-neon-orange p-6"
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-4">
                <div className="flex flex-col gap-1">
                  <button
                    ...
                    disabled={index === 0}
                    className="p-1 hover:bg-nnh-orange/10 rounded disabled:opacity-30 disabled:cursor-not-allowed"
                  >
                ...
                <div>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-white">Priority {index + 1}</span>
                  </div>
                  <p className="text-sm text-white">{provider.description}</p>
                </div>
              </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors flex items-center gap-2 ${
                  provider.is_active
                    ? 'bg-green-400/20 text-orange-500 hover:bg-green-400/30'
                    : 'bg-nnh-orange/10 text-white hover:bg-nnh-orange/20'
                ...
                <div className="flex gap-2">
                  <div className="flex-1 relative">
                    <input
                      ...
                      className="w-full bg-nnh-orange/5 border border-neon-orange shadow-neon-orange rounded-lg px-4 py-2 text-white placeholder:text-white focus:outline-none focus:border-neon-orange shadow-neon-orange"
                    />
                    <button
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-500 text-black font-semibold rounded-lg font-medium hover:from-orange-600 hover:via-orange-700 hover:to-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {saving === provider.id ? (
                      <>
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-nnh-orange/10 hover:bg-nnh-orange/20 text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
      ...
      <div className="bg-nnh-orange/5 border border-neon-orange shadow-neon-orange rounded-xl p-6">
        ...
        <div className="space-y-3 text-sm text-white">
          ...
          <div>
            ...
            <a href="https://console.anthropic.com/settings/keys" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">
              console.anthropic.com/settings/keys
            </a>
          </div>
          <div>
            <strong className="text-white">Google AI:</strong>{' '}
            <a href="https://makersuite.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">
              makersuite.google.com/app/apikey
            </a>
          </div>
          <div>
            <strong className="text-white">Groq:</strong>{' '}
            <a href="https://console.groq.com/keys" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">
